            ...
            <div class="col-md-4">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <asp:Button ID="btnEvento" runat="server" Text="Confirmar" class="btn btn-default" onclick="btnEvento_Click" />
                                            </div>                                        
                                        </div>
                ...
                <div class="row">
                    <div id="asistencia"  runat="server">
                        <asp:Button ID="btnNoVoy" class="btn btn-success" runat="server" Text="No voy" onclick="btnNoVoy_Click" />
            ...
            <div class="moduleE">
                ...
                <div class="resume-body">
                    <h3>
                        ...
                        <br/>
                        <asp:Label ID="lvlDesc" runat="server" Text=""></asp:Label>
                        <br/>
                        El <asp:Label ID="lblFecha" runat="server" Text=""></asp:Label> 
                        En <asp:Label ID="lblLugar" runat="server" Text=""></asp:Label>
                    </h3>
                    <asp:Label ID="lblDireccion" runat="server" Text=""></asp:Label>
                    <br/>
                    <asp:Label ID="lblCiudad" runat="server" Text=""></asp:Label>
                    <br/>
                    Capacidad: <asp:Label ID="lblCapacidad" runat="server" Text=""></asp:Label>
                    <br />
