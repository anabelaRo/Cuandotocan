...
<div id="contenedor">
    ...
    <script type="text/javascript">
        function hola(id, nombre, desc, fecha, lugar, tipo  ) {
            alert("entro " + id + nombre + fecha + lugar);
    ...
    <h3> Modificar evento</h3>
     <div class ="row">
         ...
         <asp:Label ID="lblNomE" runat="server" Text="Nombre: "></asp:Label></div>
             <div class ="col-md-3">
         ...
         <asp:Label ID="lblDesc" runat="server" Text="Descripción: "></asp:Label></div>
             <div class ="col-md-3">
          ...
          <div class ="row">
            <div class ="col-md-1">
             <asp:Label ID="lblfechaE" runat="server" Text="Fecha: " > </asp:Label></div>
             <div class ="col-md-3">
        ...
        <div class ="row">
            ...
            <asp:Label ID="lblLugarE" runat="server" Text="Lugar: ">  </asp:Label>
             ...
             <div class ="col-md-3">
              ...
              <asp:DropDownList ID="ddlLugar" runat="server" class="form-control">
              </asp:DropDownList>
            ...
            No hay vuelta atrás-. 
             ...
             <div class ="row">  
              <div class ="col-md-6">
            <asp:Button ID="btnUpdate" runat="server" class='btn btn-default' Text="Confirmar" 
     ...
     <div class="row">
        <h3>    
         <asp:Button ID="btnNewEvent" runat="server" Text="Crear Nuevo Evento" 
             class='btn btn-default' onclick="btnNewEvent_Click" /></h3>
     </div>
     </div>
     <div id="crearEvento1" runat="server">
      ...
      <div class ="row">
         ...
         <asp:Label ID="lblNameNuevo" runat="server" Text="Nombre: "></asp:Label></div>
             <div class ="col-md-3">
         ...
         <asp:Label ID="lblDescNueva" runat="server" Text="Descripción: "></asp:Label></div>
             <div class ="col-md-3">
          ...
          <div class ="row">
            <div class ="col-md-1">
             <asp:Label ID="lblFechaNueva" runat="server"  Text="Fecha: "> </asp:Label></div>
             <div class ="col-md-3">
        ...
        <div class ="row">
            ...
            <asp:Label ID="lblLugarNueva" runat="server" Text="Lugar: ">  </asp:Label>
             ...
             <div class ="col-md-3">
              ...
              <asp:DropDownList ID="ddlLugar2" runat="server" class="form-control">
              </asp:DropDownList>
            ...
            <asp:Label ID="lblTipoNuevo" runat="server" Text="Tipo: ">  </asp:Label>
             ...
             <div class ="col-md-3">
              ...
              <asp:DropDownList ID="ddlTIpo2" runat="server" class="form-control">
              </asp:DropDownList>
             ...
             <div class ="row">  
              <div class ="col-md-6">
            <asp:Button ID="btnCrearNuevo" runat="server" class='btn btn-default' Text="Crear" 
