    ...
    <div id="divPerfilRegistracion">
        <div class="moduleR">
            ...
            <div class="resume-body">    
                <div class="row">
                    <div class="col-sm-10"> 
                        <asp:Label ID="RegOk" runat="server" Text=""></asp:Label>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <asp:CustomValidator id="valUser2" runat="server" ControlToValidate = "regUser" ErrorMessage = "Largo máximo 20 chars" ClientValidationFunction="validateLength" ValidationGroup="registro" class="text-danger"></asp:CustomValidator>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <asp:CustomValidator id="CustomValidator1" runat="server" ControlToValidate = "regPassword" ErrorMessage = "Largo máximo 20 chars" ClientValidationFunction="validateLength" ValidationGroup="registro" class="text-danger"></asp:CustomValidator>
                    </div>
                    <div class="col-sm-2">
